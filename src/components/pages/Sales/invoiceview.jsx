...
import InvoiceLayout from "./invoiceformat";
...
const InvoiceView = () => {
    ...
    // Auto-trigger print when navigated with ?print=true
    useEffect(() => {
        ...
        <div className="min-h-screen bg-gray-100 font-sans">
            ...
            <div className="no-print flex items-center gap-3 px-6 py-3 bg-white border-b border-gray-200 shadow-sm sticky top-0 z-10">
                ...
                <span className="text-[13px] font-bold text-gray-500 uppercase tracking-wide">
                    Invoice: <span className="text-gray-900">{decoded}</span>
                </span>
            ...
            <div className="py-6 px-4">
                <InvoiceLayout InvNumber={decoded} />
            </div>
