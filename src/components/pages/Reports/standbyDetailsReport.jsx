...
const StandbyDetailsReport = () => {
  ...
  const handlePrint = () => {
      ...
      win.document.write(`
        <html><head><title>Standby Pending Details Report</title>
        <style>
          ...
          <h2>Standby Pending Details Report</h2>
  ...
  const exportPDF = () => {
      ...
      html2pdf()
        .set({
          margin: [10, 10, 10, 10],
          filename: `Standby_Pending_Details_Report_${new Date().toISOString().split("T")[0]}.pdf`,
  ...
  const exportExcel = () => {
      ...
      XLSX.utils.book_append_sheet(wb, ws, "Standby Pending Report");
      XLSX.writeFile(wb, `Standby_Pending_Details_Report_${new Date().toISOString().split("T")[0]}.xlsx`);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 font-sans">
      ...
      <div className="flex items-center justify-between mb-6 border-b pb-4">
        <div>
          <h2 className="text-2xl font-black text-gray-900 tracking-tight">STANDBY PENDING DETAILS REPORT</h2>
      ...
      <div className="mb-4 flex justify-between items-center px-2">
        <span className="text-[12px] text-gray-400 font-semibold uppercase tracking-wider">
          Standby Pending Details list ({data.length} items found)
        </span>
      </div>
          ...
          <table className="w-full border-collapse text-left text-[12.5px]">
            <thead>
              <tr className="bg-gray-800 text-white font-bold">
                ...
                <th className="px-4 py-3 border-r border-gray-700 w-[20%] whitespace-nowrap">CUSTOMER NAME</th>
                ...
                <th className="px-4 py-3 text-center border-r border-gray-700 w-[9%] whitespace-nowrap">RETURNED QTY</th>
...
export default StandbyDetailsReport;
