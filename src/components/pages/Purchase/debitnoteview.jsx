      ...
      <div className="w-[190mm] border-2 border-black bg-white relative shadow-lg overflow-hidden">
            ...
            <tbody>
              {debitnote.items.map((item, index) => (
                <tr key={index} className="border-b-2 border-black min-h-[35px]">
                  ...
                  <td className="p-2 text-right text-[12px] border-black font-bold pr-4">{Number(item.amount).toFixed(2)}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div className="border-t-2 border-black flex">
          ...
          <div className="w-[30%] border-black">
            ...
            <div className="flex border-b border-black">
              <div className="w-[50%] p-2 text-[12px] font-bold border-r border-black">SGST @18.00% </div>
              <div className="w-[50%] p-2 text-[12px] font-bold text-right pr-4">{Number(debitnote.sgst || 0).toFixed(2)}</div>
            </div>
            <div className="flex border-b border-black">
              <div className="w-[50%] p-2 text-[12px] font-bold border-r border-black">CGST @18.00% </div>
              <div className="w-[50%] p-2 text-[12px] font-bold text-right pr-4">{Number(debitnote.cgst || 0).toFixed(2)}</div>
            </div>
            <div className="flex border-b border-black">
              <div className="w-[50%] p-2 text-[12px] font-bold border-r border-black">IGST @18.00% </div>
              <div className="w-[50%] p-2 text-[12px] font-bold text-right pr-4">{Number(debitnote.igst || 0).toFixed(2)}</div>
            </div>
            <div className="flex border-b border-black">
              <div className="w-[50%] p-2 text-[12px] font-bold border-r border-black">Delivery Charge </div>
