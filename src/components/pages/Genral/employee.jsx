              ...
              {viewingDocuments.length > 0 ? (
                <>
                  ...
                  <div className="flex-1 min-h-0 bg-gray-50 rounded border overflow-hidden flex items-center justify-center">
                    {viewingDocuments[currentDocIndex].mime?.startsWith("image/") ? (
                      <img
                        src={`data:${viewingDocuments[currentDocIndex].mime};base64,${viewingDocuments[currentDocIndex].data}`}
                        alt={viewingDocuments[currentDocIndex].name}
