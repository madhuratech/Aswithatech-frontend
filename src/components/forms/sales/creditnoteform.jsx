        ...
        <div className="flex justify-end">
          ...
          <div className="flex flex-wrap gap-2 justify-end pb-6 mb-5">
            <div className="flex gap-2">
              ...
              <button onClick={submitcreditNote} className="border px-3 py-1.5 rounded-lg text-black hover:bg-green-500 hover:text-white">SAVE</button>
              <button onClick={deleteCn} className="border px-3 py-1.5 rounded-lg hover:bg-red-500 hover:text-white">DELETE</button>
          ...
          <div className="flex-1  space-y-5 min-w-0 ">
            ...
            <div>
              <label className="text-sm" >CN NO:</label>
              <input 
               value={cnNumber}
               readOnly
          ...
          <div className=" pt-3 mt-3 space-y-3 min-w-0">
            ...
            <div className=" items-center justify-between gap-3">
                  <div className="flex justify-between">
                      ...
                      <div className="items-center gap-2 min-w-0 space-y-3 relative" ref={cnRef}>
                <span>SELECT CN NO :</span>
                <input
                   value={loadCnnumber}
                ...
                <div className="absolute top-[65px] left-0  w-[250px] bg-white border border-gray-200 rounded-lg shadow-lg z-50 max-h-40 overflow-y-auto">
                 ...
                 <div className="px-3 py-2 text-gray-400 text-sm">No CN found</div>
               )}
              </div>
              )}
